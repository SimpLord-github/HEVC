...
from intra_estimation import estimate_intra_mode, VALID_BLOCK_SIZES
from intra_prediction import full_intra_pipeline, IntraResult
from motion_estimation import estimate_motion, MotionVector, ALGO_HEX
from motion_compensation import full_inter_pipeline, InterResult
...
def _evaluate_skip(
    ...
    from motion_compensation import InterResult  # noqa: F401 — already at top level
    return ModeDecision(
        mode=MODE_SKIP,
        rd_cost=j_cost,
        distortion=sse,
